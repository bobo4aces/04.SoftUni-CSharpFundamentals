        ...
        static void Main()
        {
            ...
            while ((command = Console.ReadLine()) != "End")
            {
                ...
                if (tokens.Length == 2)
                {
                    ...
                    Person parent = tree.First(p => p.BirthDate == tokens[0]);
                    ...
                    Person child = tree.First(p => p.BirthDate == tokens[1]);
                ...
                else if (tokens.Length == 3)
                {
                    if (command.Contains("-"))
                    {
                        if (Char.IsDigit(tokens[0][0]))
                        {
                            ...
                            Person child = tree.First(p => p.FirstName == tokens[1] && p.LastName == tokens[2]);
                        ...
                        else if (Char.IsDigit(tokens[2][0]))
                        {
                            ...
                            Person child = tree.First(p => p.BirthDate == tokens[2]);
                            ...
                            Person parent = tree.First(p => p.FirstName == tokens[0] && p.LastName == tokens[1]);
                ...
                else if (tokens.Length == 4)
                {
                    ...
                    Person child = tree.First(p => p.FirstName == tokens[2] && p.LastName == tokens[3]);
